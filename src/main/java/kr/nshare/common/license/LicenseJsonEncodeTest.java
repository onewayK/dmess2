...
public class LicenseJsonEncodeTest {

    private String iv;
    private Key keySpec;
    private HashMap store = new HashMap();

    public LicenseJsonEncodeTest(String key) throws UnsupportedEncodingException {
...
/*
	...
	public static void main(String [] args) throws IOException,
	    ...
	    hm.put("hostname", "test_host");
	    hm.put("mac", "10-4A-7D-45-B7-11");
	    hm.put("startDt", "2016-12-31");
	    hm.put("endDt", "2018-12-31");
	    hm.put("siteLimit", "300");
