    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/common/file_uploader_html5.do'; 	//upload URL
    ...
    function callAjaxForHTML5 (tempFile, sUploadURL){
		...
		oAjax.header("page_type", document.editor_upimage.page_type.value);
 		...
 		try{
	    	...
	    	for (var i = 0; i < aTemp.length ; i++){
	    		if( !!aTemp[i] && aTemp[i] != "" && aTemp[i].indexOf("=") > 0){
	    			...
	    			htTemp[aSubTemp[0]] = param_convert(aTemp[i]);
	    		}
	 		}
 		}catch(e){}
