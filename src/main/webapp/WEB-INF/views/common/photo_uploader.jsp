...
<title>D-MESSv1.0 file upload</title>
<style type="text/css">
...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
    	<!-- content -->
		<form id="editor_upimage" name="editor_upimage" action="/common/file_uploader.do" method="post" enctype="multipart/form-data" onSubmit="return false;">
        	 <input type="hidden" name='page_type' id="page_type" value='<c:out value="${page_type}"/>' />
              	 <div id="pop_content2">
...
<script type="text/javascript" src="/js/jindo.fileuploader.js" charset="utf-8"></script>
<script type="text/javascript" src="/js/attach_photo.js" charset="utf-8"></script>
